                        ...
                        <div class="col-md-8">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="form-group last mb-4">
                                    ...
                                    <input type="password" class="form-control" name="u_pass" autocomplete="off"
                                        required>
                                ...
                                <input type="submit" value="Log In" class="btn btn-block btn-primary" name="log_submit" style="margin-bottom:1rem;">
                            </form>
                          </div>
                        </div>
                        <span class="ml-auto" style="display: grid; place-content: center;font-size: 15px; padding-left: .6rem;    margin-top: 1rem;color: #7a7070;"> A Compelete Solution of Visitor Tracking System </span>
                      </div>
                    </div>
                </div>
            </div>
