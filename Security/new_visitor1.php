                          ...
                          <div class="card-block">
                            <form action="new_visitor2" method="post">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Whom to Meet<span
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <label type="label" class="form-control" value="Arrived"><span
                                      style="color:green; font-weight:900;">Arrived</span></label>
                                  <input type="hidden" name="visit[]" value="Arrived">
                                </div>
                              </div>
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <label type="label" class="form-control" value="Arrived"><span
                                      style="color:green; font-weight:900;"><?php echo date("d / M / Y") . " - "; ?>
                                      <span id="clock_span2"></span></span></label>
                                  <input type="hidden" name="visit[]" value="<?php echo date("h:i:s A"); ?>">
                                </div>
                              </div>
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Gate No<span style="color:red; padding:2px;">
                                    *</span></label>
                                <div class="col-sm-9">
                                  <select name="visit[]" id="" class="form-control" required>
