                          ...
                          <table class="table" id="dataTable">
                            <thead>
                              <tr>
                                ...
                                <th style="padding-bottom:2px;padding-top:2px;">Register
                                  Time</th>
                                <th style="padding-bottom:2px;padding-top:2px;">Update
                                  Time</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="padding:1px;">
                                  <?php echo $info_report['govt_id_no'] . "( " . $info_report['govt_id_type'] . " )"; ?>
                                </td>
                                <td style="padding:1px;">
                                ...
                                <td style="padding:1px;">
                                  <?php echo date("d-m-Y H:i:s", strtotime($info_report['register_date'])); ?>
                                </td>
                                <td style="padding:1px;">
