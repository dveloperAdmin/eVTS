                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Print Optiopn</label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                                   <select class="form-control" name="" id="url"  style="margin-right:1rem;" autofocus>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="user-entry">
                                                                    ...
                                                                    <button type="click"    class="btn waves-effect waves-light btn-inverse btn-outline-inverse" id="check_details"><i  class="icofont icofont-search"></i>Check Details</button>
                                                                    <button type="submit"   class="btn waves-effect waves-light btn-primary btn-outline-primary"   name="check_in" id="print_url"><i class="fa fa-print" style="    font-size: 20px;margin-right: 10px;"></i>Print</button>
                                                                    <a href="<?php echo $exit_url?>"><button type="reset"    class="btn waves-effect waves-light btn-danger btn-outline-danger"><i  class="icofont icofont-arrow-right"></i>Exit</button></a>
                                                                </div>
