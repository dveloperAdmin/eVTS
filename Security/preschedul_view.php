                                                        ...
                                                        <div class="container" style="padding:1rem;">
                                                            ...
                                                            <form action="preschedul_Image" method="post">
                                                                <div class="user-entry">
                                                                    ...
                                                                    <button type="submit"   class="btn waves-effect waves-light btn-primary btn-outline-primary"   name="view_v" style="font:normal normal normal 14px/1 FontAwesome;font-size: 20px;">Next <i class="fa fa-arrow-right" style="    font-size: 20px;margin-right: 10px;">  </i></button>
                                                                </form>    
                                                            ...
                                                            <button class="btn waves-effect waves-light btn-inverse btn-outline-inverse" name="dept_update"><i class="fa fa-arrow-left" style="font-size: 20px;margin-right: 10px;"> Back </i></button>
                                                            </a>
