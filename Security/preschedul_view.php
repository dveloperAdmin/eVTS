                                ...
                                <div class="admit-card">
                                  <div class="BoxA border- padding mar-bot">
                                    <div class="row">
                                      ...
                                      <div class="col-sm-4 txt-center" style="flex:0 0 40%; max-width:50%">
                                      ...
                                      <div class="col-sm-10" style=" max-width: 100%; flex: 0 0 100%;">
                                        <table class="table" style="margin-bottom:0px">
                                          <tbody>
                                            <tr>
                                              <td colspan="3"
                                                style="font-size:16px; padding:.3rem 1px 0px;font-weight:700;border-bottom:2px solid #000;text-align:left;">
                                                Visitor Info</td>
                                            </tr>
                                            <tr>
