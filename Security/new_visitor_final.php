                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-4" style="flex:0 0 25%">
                                  <h5 style="font-size:15px;">UID:-
                                    <?php $v_id = explode("-",$v_log_id); echo $v_id[1] ;?></h5>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td id="tb"
                                          ...
                                          <b>Visitor Name:- &nbsp;</b><?php echo $name;?> </td>
                                      ...
                                      <tr>
                                        <td id="tb"
                                          style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;">
                                          <b>Comopany:- &nbsp;</b><?php echo $company;?></td>
                                      ...
                                      <tr>
                                        <td id="tb"
                                          style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;">
                                          <b>Designation:- &nbsp;</b><?php echo $desig;?></td>
                                      ...
                                      <tr>
                                        <td id="tb"
                                          style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;">
                                          <b>Visitor Type:- &nbsp;</b><?php echo $visitor_type;?></td>
                                      ...
                                      <tr>
                                        <td id="tb"
                                          ...
                                          <b>Mterials Carried:- &nbsp;</b><span
                                            style="word-break: break-all;"><?php echo $meterial;?></span></td>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left;">
                                        <b>Employe Code:- &nbsp;</b><?php echo $emp_code;?></td>
                                    ...
                                    <tr>
                                      <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left;">
                                        <b>Department:- &nbsp;</b><?php echo $employee_depart;?></td>
