                                                    ...
                                                    <div class="card-block">
                                                        <form action="new_visit_process" method="post">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Visitor Id Card <span style="color:red;padding:2px;">*</span></label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                                    <input type="text" name="v_id_card" id="vidcard" class="form-control" placeholder="Enter Vehicale Number" required autofocus>
                                                                ...
                                                                <!-- <label type="label" class="form-control" value="Arrived"><span style="color:green; font-weight:900;" ><?php echo date("d / M / Y")." - ";  ?> <span id= "clock_span2"></span></span></label> -->
                                                                    <input type="hidden" name="arrive_date_time" value="<?php echo date("Y-m-d H:i:s");?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row" style="margin-bottom:.65rem;">
                                                            <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Visitor Type<span style="color:red;padding:2px;">*</span></label>
                                                            <div class="col-sm-9" style="flex:0 0 69%">
                                                                <select name="visit_type" id="cont" class="form-control" required>
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $visitor_type['type_id'];?>"><?php echo $visitor_type['type_name'];?></option>
                                                                    <?php    }
                                                                    ?>
                                                                </select>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Vehicle Type <span style="color:red;padding:2px;">*</span></label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Vehical No </label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                                    <input type="text" name="v_no" id="v_no" class="form-control" placeholder="Enter Vehicale Number" value="" oninput="this.value = this.value.toUpperCase()">
                                                                
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Carry Inside </label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                                <textarea type="textarea" name="carry_in"  class="form-control" placeholder="Enter The Things You are carring " value=""  rows="4" cols="10"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Permission <span style="color:red;padding:2px;">*</span></label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                                   <select class="form-control" name="action" id="url"  style="margin-right:1rem;"  required>
                                                            ...
                                                            <input type="hidden" name="vid" value="<?php echo $vlog_id;?>">
                                                                ...
                                                                <div class="user-entry">
                                                                    <button type="submit"   class="btn waves-effect waves-light btn-primary btn-outline-primary"   name="v_app" id="print_url"><i class="fa fa-ticket" style="    font-size: 20px;margin-right: 10px;"></i>Submit</button>
                                                                </form>    
                                                            ...
                                                            <button class="btn waves-effect waves-light btn-inverse btn-outline-inverse" name="dept_update"><i class="fa fa-arrow-left" style="font-size: 20px;margin-right: 10px;"></i>Back</button>
                                                            </a>
                                                            ...
                                                            <div class="BoxA border- padding mar-bot"> 
                                                                <div class="row" >
                                                                    <div class="col-sm-4" style="flex:0 0 28%">
                                                                        <h5 style="font-size:15px;">Schedul Date :- <?php echo $v_date;?></h5>
                                                                        <p style="margin-bottom:.5rem;">Schedul time: - <?php echo $arr_time;?></p>
                                                                    </div>
                                                                    <div class="col-sm-4 txt-center" style="flex:0 0 47%; max-width:50%">
                                                                        <h5 style="text-align:center;"><?php echo strtoupper($company_name);?></h5>
                                                                    </div>
                                                                    <div class="col-sm-4"style="flex:0 0 25%">
                                                                        <h5 style="font-size:15px;">UID:- <?php echo $id;?></h5>
                                                                        <p style="margin-bottom:.5rem;">Approval Sts.: - <?php echo $approval_sts;?> </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-10" style=" max-width: 100%; flex: 0 0 100%;" >
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                            <td id="tb" style="padding:0; height:2rem;text-align:left; width:45%;"><b>Visitor Name:- </b><?php echo $v_name;?> </td>
                                                                            <td style="padding:0; height:2rem;text-align:left;"><b>Govt. Id:- </b><?php echo $v_govt_id;?> </td>
                                                                            <th rowspan="4" scope="row txt-center" style="width:8rem;"><img src="../upload_temp/<?php echo $vlog_id;?>.png" width="123px" height="130px" onerror="this.src=<?php echo $dami_img;?>" /></th>
                                                                            
                                                                            </tr>
                                                                            <tr>
                                                                            <td id="tb" style="padding:0; height:2rem;text-align:left; width:45%;"><b>Comopany:- </b><?php echo  $v_c_name;?></td>
                                                                            <td style="padding:0; height:2rem;text-align:left;"><b>Mobile No :- </b><?php echo $v_mobile;?></td>
                                                                            
                                                                            </tr>
                                                                            <tr>
                                                                            <td id="tb" style="padding:0; height:2rem;text-align:left; width:45%;"><b>Designation:- </b><?php echo $v_desig;?></td>
                                                                            <td style="padding:0; height:2rem;text-align:left;"><b>Email:- </b><?php echo $v_email;?></td>
                                                                            
                                                                            </tr>
                                                                            <tr>
                                                                            <td id="tb" style="padding:0; height:2rem;text-align:left; width:45%;"><b>Address:- </b><?php echo  $v_address;?></td>
                                                                            <td style="padding:0; height:2rem;text-align:left;"><b>Issued Id No:- </b><?php echo  $v_c_no;?></td>
                                                                            
                                                                            </tr>                                                                           <tr>
                                                                            <td id="tb" style="padding:0; height:2rem;text-align:left; width:45%;"><b>Visitor Type:- </b><?php echo  $v_type;?></td>
                                                                            <td style="padding:0; height:2rem;text-align:left;"><b>Purpose: </b><?php echo  $v_p;?></td>
                                                                            <td style="padding:0; height:2rem;text-align:left;"><b>Gate No:- </b><?php echo  $v_g_no;?></td>
                                                                            </tr>
                                                                            <tr>
                                                                            <td id="tb" style="padding:0; height:2rem;text-align:left; width:45%;"><b>Mterials Carried:- </b><span style="word-break: break-all;"><?php echo  $v_mertial;?></span></td>
                                                                ...
                                                                <div class="col-sm-10" style="max-width: 100%; flex: 0 0 100%;">
                                                                        <table class="table">
                                                                            ...
                                                                            <tr ><td colspan="2" style="font-size:16px; padding: .5rem;font-weight:700;border-bottom:2px solid #000;text-align:left;"> TO Meet</td></tr>
                                                                                <tr>
                                                                                    <td id="tb" style="padding:0; height:2rem;text-align:left;"><b>Employe Code:- </b><?php echo  $v_e_code;?></td>
                                                                                    <td style="padding:0; height:2rem;text-align:left;"><b>Employe Name:- </b><?php echo $v_e_name;?></td>
                                                                                    <!-- <td><b>DOB: </b>02 Jul 2019</td> -->
                                                                                </tr>
                                                                                <tr>
                                                                                    <td id="tb" style="padding:0; height:2rem;text-align:left;"><b>Department:- </b><?php echo  $v_e_depart;?></td>
