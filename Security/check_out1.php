                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input list="emps" type="text" class="form-control"
                                                                        placeholder="Enter Visitor Log Id " name="uid"
                                                                        required id="emp" autofocus>
                                                                    <datalist id="emps">

                                                                        <?php
                                                                        $sql_v_data = mysqli_query($conn, "select * from `visitor_log` where `check_status`='IN' order by `sl_no` desc");
                                                                        while ($v_data = mysqli_fetch_assoc($sql_v_data)) {
                                                                            $log_id = explode("-", $v_data['visit_uid']);
                                                                            $log_id = $log_id[1];
                                                                            ?>
                                            ...
                                            <div class="col-md-6"
                                                ...
                                                <div class="card " id="contact1" style="margin:0;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
