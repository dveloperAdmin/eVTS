...
$des="Page Load Visit Purpose";
$rem="Visit Purpose Type";
$head = "Visit Purpose ";
include '../include/_audi_log.php';

$sql_check_data = mysqli_query($conn,"select * from `visit_purpose` order by `sl_no` desc");
$e= false;
$visit_type_data = "";
if(isset($_POST['emp_t_edit'])){
    $id = $_POST['empedit_id'];
    $e= true;
    $check_sql = mysqli_fetch_assoc(mysqli_query($conn,"select * from `visit_purpose` where `purpose_id`='$id'"));
    $visit_pur_data = $check_sql['purpose'];
                                        ...
                                        <?php if($e != true){?>
                                                ...
                                                <div class="card" style="margin-bottom: 8px;">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="padding-right: 0;">Visit Purpose</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" placeholder="Enter Visit Purpose" name="visit_pur_in" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="user-entry">
                                                                ...
                                                                <button type="submit" class="btn waves-effect waves-light btn-primary btn-outline-primary"style="padding: 7px 20px;" name="visit_pur_sub"><i class="fa fa-plus" style="    font-size: 20px;margin-right: 10px;"></i> Add Purpose</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                          ...
                                          <?php }
                                            ...
                                            <div class="col-md-6">
                                                <div class="card" style="margin-bottom: 8px;">
                                                    <div class="card-header"  style="padding-bottom:8px;padding-top:8px;">
                                                        <h5 style="width:79%"> Update Visit Purpose Details</h5>
                                                        <a href="visitor-purpose">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="padding-right: 0;">Visit Purpose</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" placeholder="Enter Visit Purpose" name="upvisit_pur_in" required value="<?php echo $visit_pur_data;?>">
                                                                </div>
                                                            </div>
                                                            <input type="hidden" name="visit_p_edit_id" value="<?php echo $id;?>">      
                                                            <div class="user-entry">

                                                                <button type="reset" class="btn waves-effect waves-light btn-inverse btn-outline-inverse"style="padding: 7px 20px;"><i class="icofont icofont-exchange"></i>Cancel</button>
                                                                <button type="submit" class="btn waves-effect waves-light btn-primary btn-outline-primary"style="padding: 7px 20px;" name="upvisit_pur_sub"><i class="fa fa-arrow-up" style="    font-size: 20px;margin-right: 10px;"></i> Update Purpose</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="card text-center order-visitor-card" id="total-visit-purpose" style="margin-bottom:8px">
                                                        <div class="card-block dsh-card signle-dash" >
                                                            ...
                                                            <div class="card-text">
                                                                <h6 class="m-b-0"> VISITOR PURPOSE</h6>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo ucfirst($visit_types['purpose']);?></td>
                                                                
                                                                
                                                                <td class="th_width">
                                                                   <form action="" method="post">
                                                                       <input type="hidden" name="empedit_id" value="<?php echo$visit_types['purpose_id'];?>" >
                                                                ...
                                                                <td class="th_width">
                                                                    <a href="process?visit_p=<?php echo$visit_types['purpose_id'];?>" class="delt_href">
