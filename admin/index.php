                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card" style="padding:.5rem;    margin-bottom: 0.8rem;">
                                            <div class="col-md-6">
                                                ...
                                                <h5 id="bio_sync" style="margin: 0;">Branch Visitor Info</h5>
                                                <?php }else{?>
                                        ...
                                        <div class="row" id="timegap">
                                            ...
                                            <?php if($user_role == "Super Admin"){ include "include/branch_dashbord.php"; }else{include "include/visitor_info.php";}?>
