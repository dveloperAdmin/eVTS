...
if(in_array($user_role, array("Developer", "Super Admin"))){
    $sql_vistor =  mysqli_query($conn,"select * from `visitor_log` order by `sl_no` desc");
    $serach_visit= mysqli_query($conn,"select distinct `visitor_id` from `visitor_log`  order by `sl_no` desc");
    
}else{
    $serach_visit= mysqli_query($conn,"select distinct `visitor_id` from `visitor_log` where `branch_id` = '$branch_id' order by `sl_no` desc");
    $sql_vistor =  mysqli_query($conn,"select * from `visitor_log` where `branch_id` = '$branch_id'  order by `sl_no` desc");
                      ...
                      <div class="card-block table-border-style">
                          ...
                          <table class="table" id="myTable">
                            <thead>
                              <tr>
                                ...
                                <th style="  width: 20%;padding-bottom:2px;padding-top:2px;">Visit To Wish</th>
                                <th style="padding-bottom:2px;padding-top:2px;">Permission</th>
                        ...
                        ?>
                              <tr>
                                ...
                                <td style="padding:1px;"><?php echo ucfirst($e_name);?></td>
                                <td style="padding:1px;">
                                  <?php 
