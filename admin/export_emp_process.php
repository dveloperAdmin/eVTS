...
function emp_table_excel($data)
{
    ...
    $table_formate = [
        ['<b>Sl_NO', '<b>Employee_Code', '<b>Employee_Name', '<b>Company_Name', '<b>Branch', '<b>Department', '<b>Sub_Department', '<b>Designation', '<b>Grade', '<b>Location', '<b>Employee_Type', '<b>Category', '<b>Contact', '<b>Email Id', '<b>Status'],
