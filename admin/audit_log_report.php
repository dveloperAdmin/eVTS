...
$head="Audit Log Report";
$des="Page Load audi_log_report";
$rem="Audi Report";
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <form action="report_process" method="post">
                                                            <div class="form-group row">
                                                                ...
                                                                <button
                                                                    ...
                                                                    style="padding: 7px 20px; background-color:none;" name="emp_audi_xls"><i
                                                                        class="icofont icofont-file-excel"
                                                                        style="    font-size: 20px;margin-right: 10px;"></i>
                                                                    Excel</button>
                                                                <button
                                                                    class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                    style="padding: 7px 20px; background-color:none;" name="emp_audi_pdf"><i
                                                        ...
                                                        <form action="report_process" method="post">
                                                            <div class="form-group row">
                                                                ...
                                                                <button
                                                                    class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                    style="padding: 7px 20px;" name="date_audi_xls"><i
                                                                        class="icofont icofont-file-excel"
                                                                        style="    font-size: 20px;margin-right: 10px;"></i>
                                                                    Excel</button>
                                                                <button
                                                                    class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                    style="padding: 7px 20px;" name="date_audi_pdf"><i
                                                                        class="icofont icofont-print"
                                                                        style="    font-size: 20px;margin-right: 10px;"></i>
                                                                    Print</button>
                                                            </div>
                                                        ...
                                                        <form action="report_process" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <button
                                                                    class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                    style="padding: 7px 20px;" name="mon_audit_xls"><i
                                                                        class="icofont icofont-file-excel"
                                                                        style="    font-size: 20px;margin-right: 10px;"></i>
                                                                    Excel</button>
                                                                <button
                                                                    class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                    style="padding: 7px 20px;" name="mon_audi_pdf"><i
                                                                        class="icofont icofont-print"
                                                                        style="    font-size: 20px;margin-right: 10px;"></i>
                                                                    Print</button>
                                                            </div>
