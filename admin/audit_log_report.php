...
if (in_array($user_role, array("Developer", "Super Admin"))) {
    ...
    $sql_user_data = mysqli_query($conn, "select * from `user` where BranchId = '$branch_id'");
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9" style="max-width: 45%;">
                                                                    ...
                                                                    <datalist id="suggestionList">
                                                                        ...
                                                                        <option data-value="1">All</option>
                                                                    ...
                                                                    <input type="hidden" name="emp_id_report"
                                                                        id="emp-hidden">
