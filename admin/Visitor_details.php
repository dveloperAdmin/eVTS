                                            ...
                                            <div class="card-header" style="padding-bottom:8px;padding-top:8px;">
                                                ...
                                                <a href="<?php echo $back_page; ?>">
                                                    ...
                                                    <button
                                                        ...
                                                        style="padding: 7px 20px;" name="dept_update"><i
                                                            ...
                                                            <div class="col-sm-10"
                                                                ...
                                                                <table class="table" style="margin-bottom:0;">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td colspan="2"
                                                                                style="font-size:16px; padding: .5rem;font-family: 'Aboreto', cursive;font-weight:700;border-bottom:2px solid #000;text-align:left;">
                                                                                TO Meet</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td id="tb"
                                                        ...
                                                        <?php if ($refer_status == 'Active' && $meeting_status != 'End') { ?>
                                                            <form action="refer_emp.php" method="post">
                                                                ...
                                                                <input type="hidden" name="emp_code"
                                                                    value="<?php echo $v_emp_code; ?>">
                                                                <button
                                                                    class="btn waves-effect waves-light btn-info btn-outline-info"
                                                                    id="print_url" style=" margin-right:1rem;" name="reffer"><i
                                                        ...
                                                        if ($end_meeting_sts != 'End' && $meeting_status != 'End') { ?>
                                                            <form action="new_visit_process.php" method="post">
                                                                ...
                                                                <button
                                                                    ...
                                                                    id="print_url" style="margin-right:1rem;"
                                                                    name="end_meeting"><i class="fa fa-arrow-right"
