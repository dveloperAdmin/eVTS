...
if(isset($_GET['del_id'])){
    $del_id =$_GET['del_id']; 
    $delete_sql_cms= mysqli_query($conn,"delete from `eomploye_details` where `EmployeeId`='$del_id'");
    $delete_sql_bio= mysqli_query($conn_bio,"delete from `employees` where `EmployeeId`='$del_id'");
    $delete_sql_bio_system= mysqli_query($conn_bio,"delete from `employeesbio` where `EmployeeId`='$del_id'");
    $delete_user = mysqli_query($conn,"delete from `user` where `EmployeeId`='$del_id'");

    if($delete_sql_cms && $delete_sql_bio && $delete_sql_bio_system){
        $_SESSION['icon']='success';
