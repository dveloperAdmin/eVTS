                                                    ...
                                                    <table class="table">
                                                        ...
                                                        $i=0;
                                                            if(in_array($user_role, array("Developer", "Super Admin"))){
                                                                $sql_query_users = mysqli_query($conn, "select * from `user` where `user_role`!='Developer'  order by `registration_time_stamp`desc");

                                                            }else{

                                                                $sql_query_users = mysqli_query($conn, "select * from `user` where `BranchId` = '$branch_id' and `uid`!='$user_id'and `user_role`!='Developer' and `user_role`!='Super Admin' order by `registration_time_stamp`desc");
                                                            }
                                                            while($user_data = mysqli_fetch_assoc($sql_query_users)){  $i++;  
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php if($sql_emp_data!=""){echo $sql_emp_data['Emp_code'];} ?></td>
                                                                <td><?php echo $user_data['user_name'];?></td>
                                                                <td><?php echo $user_data['name'];?></td>
                                                                <td><?php echo $branch_name;?></td>
                                                                <td><?php echo $user_data['user_role'];?></td>
                                                                <td><?php echo $user_data['user_sts'];?></td>
                                                                <td>
                                                                    <form action="user_view_more.php" method="post">
                                                                    <input type="hidden" name="view_id"value="<?php echo $user_data['uid'];?>">
                                                                        <button class="btn waves-effect waves-light btn-success btn-outline-success" name="view"><i class="icofont icofont-eye-alt"></i>View</button>
                                                                ...
                                                                <td>
                                                                    <form action="user_edit.php" method="post">
                                                                        ...
                                                                        <button class="btn waves-effect waves-light btn-primary btn-outline-primary" name="edit"><i class="icofont icofont-ui-edit"></i>Edit</button>
                                                                    </form>
                                                                </td>
                                                                <td>
