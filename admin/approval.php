...
if(isset($_POST['set_app_sts'])){
    ...
    $referral_sts = $_POST['referral_sts'];
    if($ap_branch!="" && $app_sts!=""){
        ...
        if(mysqli_num_rows($sql_emp_code_temp) < 1){
           $sql_insert = mysqli_query($conn,"insert into `approval_sts`(`branch_id`, `Approve_status`,`meet_end_status`,`referral_status`) values ('$ap_branch','$app_sts','$meet_end_sts','$referral_sts')");
            if($sql_insert!=""){
            ...
            $sl_no = $data['sl_no'];
            $sql_update = mysqli_query($conn,"update `approval_sts` set `branch_id`='$ap_branch',`Approve_status`='$app_sts',`meet_end_status`='$meet_end_sts',`referral_status`='$referral_sts' where `sl_no` = '$sl_no'");
            if($sql_update !=""){
                $_SESSION['icon']='success';
                                ...
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                        <div class="card"style="margin-bottom:.3rem;">
                                            <div class="card-header" style="padding-bottom:8px;padding-top:8px;margin-bottom:1rem; margin-bottom:0px;">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                <div class="row ">
                                                    <div class="col-md-6" style="max-width: 80%; flex: 0 0 40%;">
                                                        <div class="card-block table-border-style">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="padding-right: 0;max-width:7.7rem;">Branch Name</label>
                                                                <div class="col-sm-9" style="max-width: 61%;">
                                                                    <select class="form-control" id="mob"  name="branch_ap_id" style="    width: 23rem;margin-right: 1rem;"  required>
                                                                        <option value="" selected disable hidden>Select Branch</option>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="padding-right: 0;max-width:7.7rem;">Approval Status</label>
                                                                <div class="col-sm-9" style="max-width: 61%;">
                                                                    <select class="form-control" id="mob"  name="app_sts" style="width: 23rem;margin-right: 1rem;"  required>
                                                                        <option value="" selected disable hidden>Select Approval Status</option>
                                                    ...
                                                    <div class="col-md-6" style="max-width: 80%; flex: 0 0 56%;">
                                                        <div class="card-block table-border-style">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="padding-right: 0;max-width:7.7rem;">Meet End Status</label>
                                                                <div class="col-sm-9" style="max-width: 61%;">
                                                                    <select class="form-control"   name="end_sts" style="width: 23rem;margin-right: 1rem;" required >
                                                                        <option value="" selected disable hidden>Select Meet End Status</option>
                                                                        <option value="Activate">Activate</option>
                                                                        <option value="Deactivate">Deactivate</option>
                                                                    </select>                                                                        
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="padding-right: 0;max-width:7.7rem;">Referral Status</label>
                                                                <div class="col-sm-9" style="max-width: 61%;">
                                                                    <select class="form-control" name="referral_sts" style="width: 23rem;margin-right: 1rem;" required >
                                                                        <option value="" selected disable hidden>Select Referral Status</option>
                                                                        <option value="Activate">Activate</option>
                                                                        <option value="Deactivate">Deactivate</option>
                                                                    </select>                                                                        
                                                                </div>
                                                                <div class="user-entry">
                                                                    <button   class="btn waves-effect waves-light btn-primary btn-outline-primary" style="padding: 7px 20px; background-color:none;" name="set_app_sts"><i class="icofont icofont-settings-alt"  style="    font-size: 20px;margin-right: 10px;"></i>Set</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <?php $i=0; 
                                                                ...
                                                                while($Approve_data = mysqli_fetch_assoc($sql_app_sts)){$i++;
                                                                    $Branch_name ="";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo ucfirst($Approve_data['Approve_status']);?></td>
                                                                <td><?php echo ucfirst($Approve_data['meet_end_status']);?></td>
                                                                <td><?php echo ucfirst($Approve_data['referral_status']);?></td>
                                                                <td class="th_width">
