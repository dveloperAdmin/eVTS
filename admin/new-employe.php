                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="emp_process" method="post">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Enter Empolyee Code "
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-sm-3 col-form-label">Sub-Department</label>
                                                                <div class="col-sm-9">
                                                                    <select name="emp_subdept" id=""
                                                                        class="form-control fill"
                                                                        style="height: 2.3rem;">
                                                                        <option value="" disabled selected hidden>Select
                                                                        ...
                                                                        <option
                                                                            value="<?php echo $subdepartment['subdepartment_code'] ;?>">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select name="emp_Desig" id=""
                                                                        class="form-control fill"
                                                                        style="height: 2.3rem;" name="emp_Desig">
                                                                        <option value="" disabled selected hidden>Select
                                                                            Designation </option>
                                                                        <?php while($designation = mysqli_fetch_assoc($designation_details_sql)) {?>
                                                                        <option
                                                                            value="<?php echo $designation['designation_code'] ;?>">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="emp_grade" id="" class="form-control fill"
                                                                    style="height: 2.3rem;">
                                                                    <option value="" disabled selected hidden>Select
                                                                        Grade </option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="emp_loc" id="" class="form-control fill"
                                                                    style="height: 2.3rem;">
                                                                    <option value="" disabled selected hidden>Select
                                                                        Location </option>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Employe
                                                                Category</label>
                                                            <div class="col-sm-9">
                                                                <select name="emp_cat" id="" class="form-control fill"
                                                                    style="height: 2.3rem;">
                                                                    <option value="" disabled selected hidden>Select
                                                                        Employe Category </option>
                                                                    <?php while($empcat = mysqli_fetch_assoc($empcategory_details_sql)) {?>
                                                                    <option
                                                                        value="<?php echo $empcat['empcat_code'] ;?>">
                                                                        <?php echo $empcat['empcat'] ;?></option>
                                                                    <?php }?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="email" class="form-control"
                                                                    placeholder="Enter Employe Email id"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter Employe Contact no"
                                                                    name="emp_mob" maxlength="10" required>
                                                            </div>

                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Employe Status <span
                                                                    style="color:red"> *</span></label>
                                                            <div class="col-sm-9">
                                                                <select name="emp_sts" id="" class="form-control fill"
                                                                    style="height: 2.3rem;">
                                                                    <option value="" disabled selected hidden>Select
                                                        ...
                                                        <div class="form-group row user-entry"
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                name="user_submit" style="margin-left:10px"><i
                                        ...
                                        <div class="card">
                                            <div class="card-header" style="    padding: 12px 20px">
                                                <h5 style="width:91%">Edit Employee Details</h5>
                                                <a href="employe-view">
                                                <button 
                                                                class="btn waves-effect waves-light btn-inverse btn-outline-inverse"><i
                                                                    class="fa fa-arrow-right"></i>Back</button>
                                                        ...
                                                        <input type="hidden" name="edit_id" value="<?php echo $e_id;?>">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Company Name
                                                                    <span style="color:red"> *</span></label>
                                                                <div class="col-sm-9">
                                                                    <select name="uemp_co_name" id="com_name"
                                                                        class="form-control fill"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Branch <span
                                                                        style="color:red"> *</span></label>
                                                                <div class="col-sm-9">
                                                                    <select name="uemp_branch" id="Branch_name"
                                                                        class="form-control fill"
                                                                        style="height: 2.3rem;" required>
                                                                        <option value="<?php echo $emp_branch_id;?>"  selected ><?php echo $b_name;?></option>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Department <span
                                                                        style="color:red"> *</span></label>
                                                                <div class="col-sm-9">
                                                                    <select name="uemp_dept" id="dept_name"
                                                                        class="form-control fill"
                                                                        style="height: 2.3rem;" required>
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-sm-3 col-form-label">Sub-Department</label>
                                                                <div class="col-sm-9">
                                                                    <select name="uemp_subdept" id="sub_dept_name"
                                                                        class="form-control fill"
                                                                        style="height: 2.3rem;">
                                                                        <option value="<?php echo $emp_subdept_id;?>"  selected ><?php echo $sd_name;?></option>
                                                                        <?php while($subdepartment= mysqli_fetch_assoc($subdepartment_details_sql)) {?>
                                                                        <option
                                                                            value="<?php echo $subdepartment['subdepartment_code'] ;?>">
                                                                            <?php echo $subdepartment['subdepartment_name'] ;?>
                                                            ...
                                                            <div class="form-group row">
                                                                <label
                                                                    class="col-sm-3 col-form-label">Designation</label>
                                                                <div class="col-sm-9">
                                                                    <select name="uemp_Desig" id="desig_name"
                                                                        class="form-control fill"
                                                                        style="height: 2.3rem;">
                                                                        <option value="<?php echo $emp_desig_id;?>" selected ><?php echo $ds_name;?></option>
                                                                        <?php while($designation = mysqli_fetch_assoc($designation_details_sql)) {?>
                                                                        <option
                                                                            value="<?php echo $designation['designation_code'] ;?>">
                                                                            <?php echo $designation['designation'] ;?>
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="uemp_loc" id="loaction_name" class="form-control fill"
                                                                    style="height: 2.3rem;" >
                                                                    <option value="<?php echo $emp_location;?>"  selected ><?php echo $emp_location;?></option>
                                                                    <?php while($location = mysqli_fetch_assoc($location_details_sql)) {?>
                                                                    <option
                                                                        value="<?php echo $location['location'] ;?>">
                                                                        <?php echo $location['location'] ;?></option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="uemp_type" id="Emp_type_name" class="form-control fill"
                                                                    style="height: 2.3rem;">
                                                                    <option value="<?php echo $emp_emptype;?>"  selected><?php echo $emp_emptype;?></option>
                                                                    <?php while($emptype = mysqli_fetch_assoc($employetype_details_sql)) {?>
                                                                    <option value="<?php echo $emptype['emptype'] ;?>">
                                                                        <?php echo $emptype['emptype'] ;?></option>
                                                                    <?php }?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="uemp_cat" id="emp_cat_name" class="form-control fill"
                                                                    style="height: 2.3rem;">
                                                                    <option value="<?php echo $emp_empcat_id;?>"  selected ><?php echo $cat_name;?></option>
                                                                    <?php while($empcat = mysqli_fetch_assoc($empcategory_details_sql)) {?>
                                                                    <option
                                                                        value="<?php echo $empcat['empcat_code'] ;?>">
                                                                        <?php echo $empcat['empcat'] ;?></option>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">Employe Status <span
                                                                    style="color:red"> *</span></label>
                                                            <div class="col-sm-9">
                                                                <select name="uemp_sts" id="emp_sts" class="form-control fill"
                                                                    style="height: 2.3rem;" required>
                                                                    <option value="<?php echo $emp_sts;?>"  selected ><?php echo $emp_sts;?></option>
                                                                    <option value="Working">Working </option>
                                                                    <option value="Resign">Resign </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <?php if($view == false){?>
                                                            ...
                                                            <div class="form-group row user-entry"
                                                                ...
                                                                <button type="submit"
                                                                    class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                    name="user_edit" style="margin-left:10px"><i
                                                            ...
                                                            <?php }else{?>
                                                                <script>
                                                                    var ids = ['emp_sts','cont_num','emp_email_id','Emp_type_name','loaction_name','emp_name_id','grade_name','emp_cat_name','desig_name','sub_dept_name','dept_name','Branch_name','com_name'];
                                                                    for(var i = 0; i< ids.length; i++){
                                                                        if(i<6){
                                                                            $('#'+ids[i]).replaceWith("<label class='form-control'>"+$('#'+ids[i]).val()+"</label>");

                                                                        }else{
                                                                            // var value = $('#'+ids[i]+" option:selected");
                                                                            $('#'+ids[i]).replaceWith("<label class='form-control'>"+$('#'+ids[i]+" option:selected").text()+"</label>");
