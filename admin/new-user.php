                                                        ...
                                                        <form action="" method="post">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select name="user_role" id="branch" required class="form-control">
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            <option value="<?php echo $branch_detils['branch_code']?>"><?php echo $branch_detils['branch_name']; ?></option>
                                                                        <?php }  ?>
                                                                    </select> 
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input list="emps" type="text" class="form-control"
                                                                            ...
                                                                            <datalist id="emps">
                                                                                    ...
                                                                                    ?>
                                                                                    <option value="<?php echo $emp_data['EmployeeId'].' '.$emp_data['EmployeeName'];?>">
                                                                                    <?php }?>
                                                                            </datalist>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="password" class="form-control"
                                                                        placeholder="Enter Pasword " name="user_pass"
                                                                        required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">User
                                                                    Status</label>
                                                                <div class="col-sm-9">
                                                                    <select name="user_sts" id=""required class="form-control">
                                                                    <option value="" selected disabled hidden>Select User Satus</option>
