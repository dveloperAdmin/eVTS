                                            ...
                                            <div class="col-md-6" style="flex:0 0 36%;">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="view_visitor?id=1" method="post">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label" style="flex:0 0 30%; max-width:30%">Permission </label>
                                                                <div class="col-sm-9" style="flex:0 0 69%">
                                                                   <select class="form-control" name="action" id="url"  style="margin-right:1rem;" autofocus required>
                                                            ...
                                                            <div class="BoxA border- padding mar-bot"> 
                                                                <div class="row" >
                                                                    <div class="col-sm-4" style="flex:0 0 25%">
                                                                        <h5 style="font-size:15px;">Date :- <?php echo $v_date;?></h5>
                                                                        <p style="margin-bottom:.5rem;">Arrival time: - <?php echo $arr_time;?></p>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-4"style="flex:0 0 25%">
                                                                        ...
                                                                        <p style="margin-bottom:.5rem;">Checking Sts.: - <?php echo $approval_sts;?> </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-10" style=" max-width: 100%; flex: 0 0 100%;" >
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <th rowspan="4" scope="row txt-center" style="width:8rem;"><img src="../upload/<?php echo $vlog_id;?>.png" width="123px" height="130px" onerror="this.src=<?php echo $dami_img;?>" /></th>
