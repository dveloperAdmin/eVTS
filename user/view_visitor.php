...
$sql_vistor = "";
if (isset($_GET['id'])) {
    $form_action = "visitor_app_rej_details";
    $sql_udate = "";
                                                ...
                                                <div class="table-responsive table-short" style="height: 376px;">
                                                    <table class="table" id="dataTable" style="margin:0;">
                                                        <thead>
                                                            <tr>
                                                                <th
                                                                    style="width: 4rem;padding-bottom:2px;padding-top:2px;">
                                                                    Sl No.</th>
                                                                <th style="padding-bottom:2px;padding-top:2px;">Visit Id
                                                                </th>
                                                                <th
                                                                    style="  width: 20%;padding-bottom:2px;padding-top:2px;">
                                                                    Visitor Name</th>
                                                                ...
                                                                <th style="padding-bottom:2px;padding-top:2px;">Entry
                                                                    Status</th>
                                                                <th
                                                                    style="  width: 10%;padding-bottom:2px;padding-top:2px;">
                                                                    Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                                    ...
                                                                    <td style="padding:1px;">
                                                                        <form action="<?php echo $form_action; ?>"
                                                                            ...
                                                                            <input type="hidden" name="v_id"
                                                                                value="<?php echo $visitor_data['visit_uid']; ?>">
                                                                            <button
                                                                                class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                                                                name="view_v"
                                                                                style="padding: 4px 11px 4px 11px;"><i
