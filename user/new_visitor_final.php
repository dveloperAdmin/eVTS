                                                        ...
                                                        <div class="BoxA border- padding mar-bot"> 
                                                            <div class="row" >
                                                                <div class="col-sm-4" style="flex:0 0 25%">
                                                                    <h5 style="font-size:15px;">Date :- <?php echo $arr_date ;?></h5>
                                                                    
                                                                </div>
                                                                <div class="col-sm-4 txt-center" style="flex:0 0 20%; max-width:50%">
                                                                <h5 style="font-size:15px;">Arrival time: - <?php echo"00:00:00" ;?></h5>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-4"style="flex:0 0 25%">
                                                                    <h5 style="font-size:15px;">UID:- <?php $v_id = explode("-",$v_log_id); echo $v_id[1] ;?></h5>
                                                            ...
                                                            <div class="col-sm-10" style="max-width: 100%; flex: 0 0 100%;">
                                                                    <table class="table">
                                                                        ...
                                                                        <tr ><td colspan="2" style="font-size:16px; padding: .5rem;font-weight:700;border-bottom:2px solid #000;text-align:left;"> TO Meet</td></tr>
                                                                            <tr>
                                                                                <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left;"><b>Employe Code:- &nbsp;</b><?php echo $emp_code;?></td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="padding:0; height:2rem;text-align:left;"><b>Designation:- &nbsp;</b><?php echo $designation;?></td>
                                                                                <!-- <td><b>DOB: </b>02 Jul 2019</td> -->
                                                                            </tr>
                                                                    </tbody>
                                                                    </table>
                                        ...
                                        <div class="card-block " style=" padding-top:0;">
                                            ...
                                            <?php 
                                                ...
                                                ?>
                                                    ...
                                                    <a href="new_visitor1"><button type="button" class="btn waves-effect waves-light btn-inverse btn-outline-inverse"><i  class="icofont icofont-exchange"></i>Cancel</button></a>
                                                    <button type="submit"   class="btn waves-effect waves-light btn-primary btn-outline-primary"   name="final_dubmit" style="margin-left:1rem;"><i class="fa fa-arrow-right" style="    font-size: 20px;margin-right: 10px;"></i>Save & Next</button>
                                                </form>
