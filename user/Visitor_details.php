...
if (isset($_POST['view_v'])) {
  ...
  if ($visit_data != "") {
    ...
    if ($emp_details) {
      ...
      $vBranchDetails = $emp_details['BranchId'];
                      ...
                      <div class="card-header" style="padding-bottom:8px;padding-top:8px;">
                        ...
                        <a href="<?php echo $back_page ?>">
                          ...
                          <button class="btn waves-effect waves-light btn-inverse btn-outline-inverse"
                            style="padding: 5px 20px;" name="dept_update"><i class="fa fa-arrow-left"
                                ...
                                <table class="table" style="margin-bottom:0;">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left;">
                                        <b>Branch:-
                                          &nbsp;</b><?= findBranch($conn, $vBranchDetails) ?>
                                      </td>
