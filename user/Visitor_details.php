...
if(isset($_POST['view_v'])){
    ...
    if($visit_data!=""){
        ...
        $emp_details = mysqli_fetch_assoc(mysqli_query($conn,"select *from `eomploye_details` where `Emp_code`='$v_emp_code'"));
        if($emp_details){
        ...
        if($visitor_details_sql!=""){
            ...
            // $v_govt_id = str_pad(substr($v_govt_id, -4), strlen($v_govt_id), '*', STR_PAD_LEFT);
        }
    ...
    if(isset($_POST['reffer_page'])){
        $back_page = 'view_refer_visitor';
    }else{
        $back_page = 'view_visitor';
    }
}
else{
    $_SESSION['icon'] = 'info';
    $_SESSION['status'] = 'No data Vailable...... ';
                                    ...
                                    <div class="page-body">
                                        <div class="card" style="margin-bottom:0px;">
                                            <div class="card-header"  style="padding-bottom:8px;padding-top:8px;">
                                                <h5 style="width:90%">Visitor Details :- <?php $v_id = explode("-",$visitor_id); echo $v_id[1] ;?></h5>
                                                
                                               
                                                <a href="<?php echo $back_page ?>">
                                                 
                                                    <button class="btn waves-effect waves-light btn-inverse btn-outline-inverse"style="padding: 7px 20px;" name="dept_update"><i class="fa fa-arrow-left" style="font-size: 20px;margin-right: 10px;"></i>Back</button>
                                                ...
                                                <div class="container" style="padding:1rem;padding-bottom: 0rem;">
                                                    <div class="admit-card">
                                                        <div class="BoxA border- padding mar-bot"> 
                                                            <div class="row" >
                                                                <div class="col-sm-4" style="flex:0 0 28%; ">
                                                                    <h5 style="font-size:15px;">In Date-Time :- <span style="font-style: italic;"><?php echo $v_in_date .' '.$arr_time;?></span></h5>
                                                                    
                                                                </div>
                                                                <div class="col-sm-4 txt-center" style="flex:0 0 43%; max-width:50%; text-align: center;">
                                                                    <h5 style="font-size:15px;">Approval Sts.: - <?php echo $approval_sts;?> </h5>
                                                                </div>
                                                                <div class="col-sm-4" style="flex:0 0 29%;">
                                                                    <h5 style="font-size:15px;">Out Date-Time :- <span style="font-style: italic;"><?php echo $check_out?></span></h5>
                                                        ...
                                                        <div class="BoxA border- padding mar-bot"> 
                                                            <div class="row" >
                                                                <div class="col-sm-4" style="flex:0 0 28%; ">
                                                                    <h5 style="font-size:15px;">Meeting status :- <span style="font-style: italic;"><?php echo $meeting_end_sts?></span></h5>
                                                                    
                                                                </div>
                                                                <div class="col-sm-4 txt-center" style="flex:0 0 43%; max-width:50%; text-align: center;">
                                                                    <h5 style="font-size:15px;">Meeting End By.: - <?php echo $meeting_end_by;?> </h5>
                                                                </div>
                                                                <div class="col-sm-4" style="flex:0 0 29%;">
                                                                    <h5 style="font-size:15px;">End Date-Time :- <span style="font-style: italic;"><?php echo $meeting_end_date_time?></span></h5>
                                                        ...
                                                        <div class="BoxD mar-bot">
                                                            <div class="row">
                                                                <div class="col-sm-10" style=" max-width: 100%; flex: 0 0 100%;" >
                                                                    ...
                                                                    <tbody>
                                                                        <tr ><td colspan="3" style="font-size:16px; padding: .5rem 1px .2rem;font-family: 'Aboreto', cursive;font-weight:700;border-bottom:2px solid #000;text-align:left;"> Visitor Info</td></tr>
                                                                        <tr>
                                                                        <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;"><b>Visitor Name:- &nbsp;</b><?php echo $name;?> </td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Govt. Id:- &nbsp;</b><?php echo $v_govt_id;?> </td>
                                                                        <th rowspan="4" scope="row txt-center" style="width:8rem;"><img src="../upload/<?php echo $visitor_id;?>.png" width="123px" height="120px" onerror="this.src='../src/error.png'" /></th>
                                                                        
                                                                        </tr>
                                                                        <tr>
                                                                        <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;"><b>Comopany:- &nbsp;</b><?php echo $company;?></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Mobile No :- &nbsp;</b><?php echo $cont;?></td>
                                                                        
                                                                        </tr>
                                                                        <tr>
                                                                        <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;"><b>Designation:- &nbsp;</b><?php echo $desig;?></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Email:- &nbsp;</b><?php echo $gmail;?></td>
                                                                        
                                                                        </tr>
                                                                        <tr>
                                                                        <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;"><b>Address:- &nbsp;</b><?php echo $add;?></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Issued Id No:- &nbsp;</b><?php echo $issud_id_no;?></td>
                                                                        
                                                                        </tr>
                                                                        <tr>
                                                                        <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;"><b>Visitor Type:- &nbsp;</b><?php echo $visitor_type;?></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Purpose: &nbsp;</b><?php echo $visit_purpose;?></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Gate No:- &nbsp;</b><?php echo $gate_no;?></td>
                                                                        </tr>
                                                                        <tr>
                                                                        <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left; width:45%;"><b>Mterials Carried:- &nbsp;</b><span style="word-break: break-all;"><?php echo $meterial;?></span></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><b>Vehicle Type(With No): &nbsp;</b><?php echo $v_vehicle_type;?></td>
                                                                        <td style="padding:0; height:2rem;text-align:left;"><?php echo $v_vehicle_no;?></td>
                                                                        </tr>
                                                                    </tbody>
                                                                    </table>
                                                                </div>
                                                        ...
                                                        <div class="row" >
                                                            <div class="col-sm-10" style="max-width: 100%; flex: 0 0 100%;">
                                                                    <table class="table" style="margin-bottom:0;">
                                                                        <tbody>
                                                                        <tr ><td colspan="2" style="font-size:16px; padding: .5rem;font-family: 'Aboreto', cursive;font-weight:700;border-bottom:2px solid #000;text-align:left;"> TO Meet</td></tr>
                                                                            <tr>
                                                                                <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left;"><b>Employe Code:- &nbsp;</b><?php echo $v_emp_code;?></td>
                                                                                <td style="padding:0; height:2rem;text-align:left;"><b>Employe Name:- &nbsp;</b><?php echo $employee_name;?></td>
                                                                                <!-- <td><b>DOB: </b>02 Jul 2019</td> -->
                                                                            </tr>
                                                                            <tr>
                                                                                <td id="tb" style="padding:0;padding-left: 1rem; height:2rem;text-align:left;"><b>Department:- &nbsp;</b><?php echo $employee_depart;?></td>
                                                                                <td style="padding:0; height:2rem;text-align:left;"><b>Designation:- &nbsp;</b><?php echo $v_e_desig;?></td>
                                                                                <!-- <td><b>DOB: </b>02 Jul 2019</td> -->
                                                                            </tr>
                                                                    </tbody>
                                                                    </table>
                                            ...
                                            <?php if( $check_in_sts == 'IN' && $refer_details >=1 ){?>                                 
                                                <div class="card-block " style=" padding-top:0;">
                                                    <div class="user-entry" style="margin-right: 1.3rem; display:flex; width:30rem;place-content: end;">
                                                    <?php if($refer_status =='Active' && $meeting_status!='End'){?>
                                                    <form action="refer_emp" method="post">
                                                        ...
                                                        <button class="btn waves-effect waves-light btn-info btn-outline-info"  id="print_url" style=" margin-right:1rem;"  name="reffer" ><i class="icofont icofont-rotation" style="    font-size: 20px;margin-right: 10px;"></i>Reffer</button>
                                                    ...
                                                    <form action="new_visit_process" method="post">
                                                        ...
                                                        <button class="btn waves-effect waves-light btn-success btn-outline-success"  id="print_url" style="margin-right:1rem;"  name="end_meeting" ><i class="fa fa-arrow-right" style="    font-size: 20px;margin-right: 10px;"></i>End Meeting</button>
