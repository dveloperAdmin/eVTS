...
<nav class="navbar header-navbar pcoded-header">
  <div class="navbar-wrapper">
    ...
    <div class="navbar-logo">
      ...
      <a href="index.php">
        <h5 class="lineUp" style="text-transform: none;font-family: 'El Messiri', sans-serif;font-size:2.5rem;"><img
            class="img-fluid" src="assets/images/favicon.png" alt="Theme-Logo" style="    padding-right: 1rem;" /> eVTS
        </h5>
      </a>
