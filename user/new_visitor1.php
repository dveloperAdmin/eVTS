                                                    ...
                                                    <div class="card-block">
                                                        <form action="new_visitor2" method="post">
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Employee Name<span style="color:red; padding:2px;"> *</span></label>
                                                                <div class="col-sm-9">
                                                                    <input list="emps" type="text" class="form-control"  placeholder="Enter Employe Name " name="visit[]" oninput="this.value = this.value.toUpperCase()" required id="emp" autofocus>
                                                                        <datalist id="emps">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <label type="label" class="form-control" value="Arrived"><span style="color:green; font-weight:900;">Pre Schedule</span></label>
                                                                    <input type="hidden" name="visit[]" value="PRE SCHEDULE" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label"> Date <span style="color:red; padding:2px;"> *</span></label>
                                                                <div class="col-sm-9">
                                                                    ...
                                                                    <input type="date"class="form-control" id="date_picker" name="visit[]" value="" required>
                                                                    <!-- <span style="color:red">* Date Should be greter then Today</span> -->
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Gate No<span style="color:red; padding:2px;"> *</span></label>
                                                                <div class="col-sm-9">
                                                                   <select name="visit[]" id="gt_info" class="form-control" required>
                                                                    <option value="" selected disabled hidden>Select Gate No</option>
                                                                   <?php 
                                                                        $sql_gate = mysqli_query($conn, "select * from `gate_info`") ;
                                                                        while($gate = mysqli_fetch_assoc($sql_gate)){
                                                                   ?>
                                                                    <option value="<?php echo $gate['gate_number'];?>"><?php echo $gate['gate_number'];?></option>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Visit Purpose<span style="color:red; padding:2px;"> *</span></label>
                                                                <div class="col-sm-9">
                                                                    <select name="visit[]" id="v_p" class="form-control" required>
                                                                   ...
                                                                   ?>
                                                                    <option value="<?php echo $pur['purpose_id'];?>"><?php echo $pur['purpose'];?></option>
                                                            ...
                                                            <div class="user-entry">
                                                                ...
                                                                <button type="submit"   class="btn waves-effect waves-light btn-primary btn-outline-primary"   name="u_submit"><i class="fa fa-arrow-right" style="    font-size: 20px;margin-right: 10px;"></i>Next</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
