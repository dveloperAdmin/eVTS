...
function table_data($data)
{
    ...
    <tr>
        <th colspan = '12' style= 'font-size: 23px; font-style: italic;'>" . $comName . "</th>
        
    </tr>
    <tr>
        <th colspan = '12'style= 'font-size: 18px;font-style: italic;' >LogIn Report</th>
    ...
    while ($rec = mysqli_fetch_assoc($data)) {
        ...
        $branchName = findBranch($conn, $user_data_pick['BranchId']);
