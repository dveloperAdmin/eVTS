                          ...
                          <div class="card-block table-border-style">
                            <form action="report_process" method="post">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label" style="padding-right: 0;">My Log Report</label>
                                <div class="col-sm-9" style="max-width: 45%;">
                                  <label for="" class="form-control"><?php echo $_SESSION['user_name'];?></label>
                                  <input type="hidden" name="emp_id_report" value="<?php echo $_SESSION['user_id'];?>">
                                </div>
                                <div class="user-entry">
                                  ...
                                  <button class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                    style="padding: 7px 20px; background-color:none;" name="emp_r_pdf"><i
                                      class="icofont icofont-print" style="    font-size: 20px;margin-right: 10px;"></i>
                                    Print</button>
                                </div>
                              </div>
                            </form>
                            <form action="report_process" method="post">
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label" style="padding-right: 0;">Date Wise</label>
                                <div class="col-sm-9" style="max-width: 45%;">
                                  <input type="date" class="form-control" id="emp_date" placeholder="Enter Item Name"
                                    name="date_report">
                                  <input type="hidden" name="user_id" value="<?php echo $user_id;?>">
                                </div>
                                <div class="user-entry">
                                  <button class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                    style="padding: 7px 20px;" name="date_r_xls"><i class="icofont icofont-file-excel"
                                      style="    font-size: 20px;margin-right: 10px;"></i>
                                    Excel</button>
                                  <button class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                    style="padding: 7px 20px;" name="date_r_pdf"><i class="icofont icofont-print"
                                      style="    font-size: 20px;margin-right: 10px;"></i>
                                    Print</button>
                                </div>
                              </div>
                            ...
                            <form action="report_process" method="post">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label" style="padding-right: 0;">Month Wise</label>
                                ...
                                <div class="user-entry">
                                  <button class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                    style="padding: 7px 20px;" name="mon_r_xls"><i class="icofont icofont-file-excel"
                                      style="    font-size: 20px;margin-right: 10px;"></i>
                                    Excel</button>
                                  <button class="btn waves-effect waves-light btn-primary btn-outline-primary"
                                    style="padding: 7px 20px;" name="mon_r_pdf"><i class="icofont icofont-print"
                                      style="    font-size: 20px;margin-right: 10px;"></i>
                                    Print</button>
                                </div>
                              </div>
